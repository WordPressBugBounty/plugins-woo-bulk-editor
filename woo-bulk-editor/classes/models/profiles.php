	...
	protected function init_constructor_data() {
		...
		if ( ! $this->get() ) {
			...
			$this->create(
				...
				esc_html__( 'Default', 'woo-bulk-editor' ),
				'default'
			);
			...
			$this->create(
				...
				esc_html__( 'For variations fields only', 'woo-bulk-editor' ),
				'for_variations'
			);
			...
			$this->create(
				...
				esc_html__( 'Stock', 'woo-bulk-editor' ),
				'for_stock'
			);
			...
			$this->create(
				...
				esc_html__( 'Prices', 'woo-bulk-editor' ),
				'for_prices'
			);
			...
			$this->create(
				...
				esc_html__( 'Downloads, Cross-sells, Up-sells, Grouped', 'woo-bulk-editor' ),
				'for_attachments'
			);
		}
	}
