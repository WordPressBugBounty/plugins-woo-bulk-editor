		...
		switch ( $field_type ) {
			...
			case 'downloads':
				...
				$downloads = $this->prepare_downloads(
					isset( $value['_wc_file_names'] ) ? $value['_wc_file_names'] : array(),
					isset( $value['_wc_file_urls'] ) ? $value['_wc_file_urls'] : array(),
					isset( $value['_wc_file_hashes'] ) ? $value['_wc_file_hashes'] : array()
				);
		...
		switch ( $field_type ) {
			...
			case 'taxonomy':
				$res = wp_get_post_terms(
					$product_id,
					$this->settings->get_fields()[ $field_key ]['taxonomy'],
					array(
						// 'fields' => 'ids',
								'hide_empty' => false,
					)
