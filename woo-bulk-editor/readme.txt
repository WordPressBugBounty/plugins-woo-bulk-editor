...
= 1.1.7.1 =
* fix: clear scalar field value properly when emptied
...
* New feature: you can now create a woobe.css file in your current WordPress theme folder to fully customize the BEAR admin panel's appearance
