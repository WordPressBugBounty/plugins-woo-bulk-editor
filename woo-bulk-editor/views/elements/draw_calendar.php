...
<input type="text" onmouseover="woobe_init_calendar(this)" data-time="<?php echo ( $time ) ? 'true' : 'false'; ?>" data-title="<?php echo esc_html( str_replace( '"', '', wp_strip_all_tags( $product_title ) ) ); ?>" data-val-id="calendar_<?php echo esc_attr( $field_key ); ?>_<?php echo esc_attr( $product_id ); ?>" value="<?php echo $val ? esc_html( gmdate( $format, $val ) ) : ''; ?>" class="woobe_calendar" placeholder="<?php echo esc_html( $print_placeholder ? $product_title : '' ); ?>" />
