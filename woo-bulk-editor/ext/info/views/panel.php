...
<div class="col-lg-12">
	<a href="https://products-filter.com/" title="WOOF - WooCommerce Products Filter" target="_blank">
		<img width="200" src="<?php echo esc_url( WOOBE_LINK ); ?>assets/images/woof_banner.png" alt="WOOF - WooCommerce Products Filter" />
	</a>

	<a href="https://currency-switcher.com/" title="WOOCS - WooCommerce Currency Switcher" target="_blank">
		<img width="200" src="<?php echo esc_url( WOOBE_LINK ); ?>assets/images/woocs_banner.png" alt="WOOCS - WooCommerce Currency Switcher" />
	</a>

	<a href="https://products-tables.com/" title="WOOT - WooCommerce Active Products Tables" target="_blank">
		<img width="200" src="<?php echo esc_url( WOOBE_LINK ); ?>assets/images/woot_banner.png" alt="WOOT - WooCommerce Active Products Tables" />
	</a>

	<a href="https://botoscope.com/" title="BOTOSCOPE - Bridge your WooCommerce store and Telegram" target="_blank">
		<img width="240" src="<?php echo esc_url( WOOBE_ASSETS_LINK ); ?>images/bs-banner-min.png" alt="BOTOSCOPE - Bridge your WooCommerce store and Telegram">
	</a>
